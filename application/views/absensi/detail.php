<div class="row mb-2">
	...
	<div class="d-inline ml-auto float-right">			<a href="<?=is_level('Manager')?base_url('absensi/filter_divisi/').$karyawan->id_divisi:base_url('dashboard')?>" class="btn btn-success btn-sm" type="button" ><i class="fa fa-chevron-left"></i>  <strong>Kembali</strong><br /></a>  </div>
