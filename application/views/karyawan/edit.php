            ...
            <form action="<?= base_url('karyawan/update') ?>" method="post">
                ...
                <div class="card-body border-top py-0 my-3">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                <label for="telp">Pendidikan : </label>
                                <input type="text" name="pendidikan" id="pendidikan" value="<?= $karyawan->pendidikan ?>" class="form-control" placeholder="Masukan Pendidikan" required="required" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                <label for="email">Tugas : </label>
                                <input type="text" name="tugas" id="tugas" value="<?= $karyawan->tugas ?>" class="form-control" placeholder="Masukan Tugas" required="required" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                <label for="email">Alamat : </label>
                                <input type="text" name="alamat" id="alamat" value="<?= $karyawan->alamat ?>" class="form-control" placeholder="Masukan Alamat" required="required" />
                            </div>
                        </div>
                    </div>
                </div>
