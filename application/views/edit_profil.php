                    ...
                    <div class="row">
                        <div class="col-xs-12 <?= ($this->session->level == 'Karyawan') ? 'col-sm-6 col-md-4' : 'col-sm-6' ?>">
                            <div class="form-group">
                                ...
                                <input type="tel" name="pendidikan" id="pendidikan" value="<?= $user->pendidikan ?>" class="form-control" placeholder="Masukkan Pendidikan" required="reuqired" />
                            </div>
                        </div>
                        <div class="col-xs-12 <?= ($this->session->level == 'Karyawan') ? 'col-sm-6 col-md-4' : 'col-sm-6' ?>">
                            <div class="form-group">
                                <label for="tugas">Tugas : </label>
                                <input type="tel" name="tugas" id="tugas" value="<?= $user->tugas ?>" class="form-control" placeholder="Masukkan Tugas" required="reuqired" />
                            </div>
                        </div>
                        <div class="col-xs-12 <?= ($this->session->level == 'Karyawan') ? 'col-sm-6 col-md-4' : 'col-sm-6' ?>">
                            <div class="form-group">
                                <label for="alamat">Alamat : </label>
                                <input type="tel" name="alamat" id="alamat" value="<?= $user->alamat ?>" class="form-control" placeholder="Masukkan Alamat" required="reuqired" />
                            </div>
                        </div>
                    </div>
                </div>
