        ...
        <div class="modal-content">
            <form id="form-add-divisi" action="<?= base_url('divisi/store') ?>" method="post" onsubmit="return false">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-add-divisi-label">Tambah Lokasi Karyawan</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="nama-divisi">Nama Lokasi :</label>
                        <input type="text" name="nama_divisi" id="nama-divisi" class="form-control" placeholder="Nama Lokasi" required="reuired" />
                    </div>
                </div>
